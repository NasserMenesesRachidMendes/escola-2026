...
* The original package name 'br.edu.ifmg.escola-2026' is invalid and this project uses 'br.edu.ifmg.escola_2026' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/web/spring-hateoas.html)
